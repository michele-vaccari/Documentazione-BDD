...
\input{capitoli/capitolo-1}   % specifiche del progetto
\input{capitoli/capitolo-2}   % progettazione del diagramma ER
\input{capitoli/capitolo-3}   % traduzione del modello ER in modello relazionale
\input{capitoli/capitolo-4}   % normalizzazione del modello relazionale
\input{capitoli/capitolo-5}   % codice SQL
%\input{capitoli/capitolo-6}   % interfaccia grafica
%\appendix
